...
public class AuthController {
    ...
    public ResponseDto<Map<String, String>> getKakaoRedirectUrl() {
        ...
        map.put("url", authenticationService.getRedirectUrl(ELoginProvider.KAKAO));
    ...
    public ResponseDto<Map<String, String>> getGOOGLE_REDIRECT_URL() {
        Map<String, String> map = new HashMap<>();
        map.put("url", authenticationService.getRedirectUrl(ELoginProvider.GOOGLE));
        return new ResponseDto(map);
    }
    ...
    public ResponseDto<Map<String, String>> getAppleRedirectUrl() {
        Map<String, String> map = new HashMap<>();
        map.put("url", authenticationService.getRedirectUrl(ELoginProvider.APPLE));
        return new ResponseDto(map);
    }
    ...
    public ResponseDto<JwtResponseDto> loginKakao(HttpServletRequest request) {
        return new ResponseDto<>(authenticationService.login(JwtProvider.refineToken(request), ELoginProvider.KAKAO));
    }

    @PostMapping("/google")
    public ResponseDto<JwtResponseDto> loginGoogle(HttpServletRequest request) {
        return new ResponseDto<>(authenticationService.login(JwtProvider.refineToken(request), ELoginProvider.GOOGLE));
    }

    @PostMapping("/apple")
    public ResponseDto<JwtResponseDto> loginApple(HttpServletRequest request) {
        return new ResponseDto<>(authenticationService.login(JwtProvider.refineToken(request), ELoginProvider.APPLE));
    }
    ...
    public ResponseDto<String> getKakaoAccessToken(@RequestParam("code") String code) {
        return new ResponseDto<>(authenticationService.getAccessToken(code, ELoginProvider.KAKAO));
    }

    @GetMapping("/google/callback")
    public ResponseDto<String> loginGoogle(@RequestParam("code") String code) {
        return new ResponseDto<>(authenticationService.getAccessToken(code, ELoginProvider.GOOGLE));
    }

    @PostMapping(value = "/apple/callback")
    public ResponseDto<?> loginApple(@RequestParam("code") String code) {
        return new ResponseDto<>(authenticationService.getAccessToken(code, ELoginProvider.APPLE));
    }
